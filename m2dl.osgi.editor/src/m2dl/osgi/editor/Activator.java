...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		final ServiceTrackerCustomizer<ColoratorCssService, ColoratorCssService> coloratorCssServiceTrackerCustomiser = new ColoratorCssServiceTrackerCustomiser(
				bundleContext);
		...
		if (!windowIsRunning) {
			...
			Platform.runLater(() -> {
				try {
					...
					controller.setColoratorCssService(coloratorCssServiceTracker);
